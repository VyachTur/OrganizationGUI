...
namespace OrganizationGUI.Classes
{
    ...
    class AssociateDirector : Worker, ISalary
    {
        ...
        protected AssociateDirector(string name, string lastName, int salary)
        {
            Name = name;
            LastName = lastName;
            Salary = salary;
        ...
        /// <param name="salary"></param>
        /// <returns></returns>
        public static AssociateDirector getInstance(string name, string lastName, int salary)
        {
            if (instance == null)
                instance = new AssociateDirector(name, lastName, salary);
            return instance;
        }
